        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">Gestionar Paciente</h1>
                        </div>
                        <ol class="breadcrumb">
                            <li>
                                <span>Doctor</span>
                ...
                <div class="container-fluid container-fullw bg-white">
                    <div class="row">
                        <div class="col-md-12">
                            <h5 class="over-title margin-bottom-15"> <span class="text-bold"> Gestionar Paciente</span></h5>
                            ...
                            <table class="table table-hover" id="sample-table-1">
                                ...
                                <tr>
                                    ...
                                    <th>Numero Contacto Paciente</th>
                                    <th>Sexo Paciente </th>
