			...
			<div class="box-register">
				<form name="registration" id="registration" method="post">
					<fieldset>
						...
						<p>
							Ingrese los Detalle de su Cuenta:
						</p>
						<div class="form-group">
				...
				<div class="copyright">
					&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> CMIF</span>. <span>Todos los Derechos Reservados</span>
				</div>
