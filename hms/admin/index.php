	...
	<div class="row">
		<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="logo margin-top-30">
				<h2 style="font-weight: 600;color: #000;">LOGIN ADMINISTRADOR </h2>
			</div>
			...
			<div class="box-login">
				<form class="form-login" method="post">
					<fieldset>
						...
						<p>
							Ingrese Usuario y Contraseña para Iniciar Sesión<br />
				...
				<div class="copyright">
					&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> CMF </span>. <span></span>
				</div>
