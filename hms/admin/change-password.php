											...
											<div class="panel-body">
												...
												<form role="form" name="chngpwd" method="post" onSubmit="return valid();">
													<div class="form-group">
														...
														<input type="Contraseña" name="cpass" class="form-control" placeholder="Ingrese su Contraseña">
													</div>
													<div class="form-group">
														<label for="exampleInputPassword1">
															Nuevo Contraseña
														</label>
														<input type="Contraseña" name="npass" class="form-control" placeholder="Nueva Contraseña">
													</div>
													...
													<div class="form-group">
														...
														<input type="Contraseña" name="cfpass" class="form-control" placeholder="Confirme su contraseña">
													</div>
